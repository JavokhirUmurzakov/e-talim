                            ...
                            <div class="modal-dialog modal-xl modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{ route('mv_admin_yunalishlar_cre') }}" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="nomi"  placeholder="Xabar muallifi" required></input>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="logo" class="form-control"  placeholder="Yo'nalish logotipi" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="validationCustom01">Faolligi</label>
                                                            <input type="checkbox" name="faol" class="form-control"  placeholder="Faolligi" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                ...
                                <td>
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <form action="{{ route('mv_admin_yunalishlar_del') }}" method="POST">
                                                    @csrf
                            ...
                            <div class="modal fade bs-example-modal-xl{{$yun->yun_id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel{{$yun->yun_id}}" aria-hidden="true">
                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form name="edit-blog-post-form" id="edit-blog-post-form" method="post" action="{{ route('mv_admin_yunalishlar_edit',$yun->yun_id) }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col-6">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label for="validationCustom01">Yo'nalish logotipi</label>
                                                                <input type="text" value="{{$yun->logo}}" name="logo" class="form-control"  required>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label for="validationCustom01">Faolligi</label>
                                                                <input type="checkbox" @if($yun->faol) checked @endif" name="faol" class="form-control" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
