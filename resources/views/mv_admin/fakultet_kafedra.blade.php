                            ...
                            <div class="modal-dialog modal-xl modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{ route('mv_admin_fakultet_kafedra_cre') }}" enctype="multipart/form-data">
                                            @csrf
                                ...
                                <td>
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <form action="{{ route('mv_admin_fakultet_kafedra_del') }}" method="POST">
                                                    @csrf
                            ...
                            <div class="modal fade bs-example-modal-xl{{$fkf->id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel{{$fkf->id}}" aria-hidden="true">
                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form name="edit-blog-post-form{{$fkf->id}}" id="edit-blog-post-form{{$fkf->id}}" method="post" action="{{ route('mv_admin_fakultet_kafedra_edit',$fkf->id) }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col-6">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label>Batafsil</label>
                                                                <textarea id="textarea" class="form-control" name="haqida" rows="3" required>{{$fkf->nomi}}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
