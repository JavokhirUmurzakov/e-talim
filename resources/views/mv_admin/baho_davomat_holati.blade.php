    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Baho davomat holati jadvali</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">E-talim</a></li>
                        <li class="breadcrumb-item active">Baho davomat holati</li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="modal-dialog modal-xl modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title mt-0" id="myExtraLargeModalLabel1">Baho davomat holatiga yangi qator qo'shish</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{ route('mv_admin.baho_davomat_holat.create') }}" enctype="multipart/form-data">
                                            @csrf
                                            @method('post')
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="validationCustom01">Baho davomat holati nomi</label>
                                                            <input type="text" name="nomi" class="form-control"  placeholder="Baho davomat holati nomi" required>
                    ...
                    <table id="datatable-buttons1" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        <thead>
                        <tr>
                            <th>Baho davomat holati</th>
                            <th>Amallar</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach($baho_davomat_holats as $bdh)
                            <tr>
                                <td>{{$bdh->nomi}}</td>
                                ...
                                <td>
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-6">
                                                <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-xl{{$bdh->id}}">
                                                    <i class="ri-edit-2-line" style="height: 24px; width: 24px; color: #3e8f3e; align-content: center"></i>
                                                </button>
                                            </div>
                                            <div class="col-6">
                                                <form action="{{ route('mv_admin.baho_davomat_holat.delete',$bdh->id) }}" method="POST">
                                                    @csrf
                                                    @method('delete')                                                    <button type="submit"  class="btn btn-primary">
                            ...
                            <div class="modal fade bs-example-modal-xl{{$bdh->id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel{{$bdh->id}}" aria-hidden="true">
                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title mt-0" id="myExtraLargeModalLabel{{$bdh->id}}">Baho davomat holatini tahrirlash</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form name="edit-blog-post-form" id="edit-blog-post-form1" method="post" action="{{ route('mv_admin.baho_davomat_holat.edit',$bdh->id) }}" enctype="multipart/form-data">
                                                @csrf
                                                @method('put')
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label for="validationCustom01">Baho davomat holati nomi</label>
                                                                <input type="text" value="{{$bdh->nomi}}" name="nomi" class="form-control" required>
                                                            </div>
                                                        </div>
