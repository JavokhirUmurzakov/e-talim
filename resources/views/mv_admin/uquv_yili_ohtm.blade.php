                            ...
                            <div class="modal-dialog modal-xl modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{ route('mv_admin_uquv_yili_ohtm_cre') }}" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="uquv_yili_id" class="form-control" required>
                                                                <option>Tanlash...</option>
                                                                @foreach($uquv as $uq)
                                                                    <option value="{{$uq['id']}}">{{$uq['nomi']}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="faol" class="form-control"  placeholder="Faol" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                ...
                                <td>
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <form action="{{ route('mv_admin_uquv_yili_ohtm_del') }}" method="POST">
                                                    @csrf
                            ...
                            <div class="modal fade bs-example-modal-xl{{$uqv->uquv_yili_id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel{{$uqv->uquv_yili_id}}" aria-hidden="true">
                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form name="edit-blog-post-form" id="edit-blog-post-form" method="post" action="{{ route('mv_admin_uquv_yili_ohtm_edit',$uqv->uquv_yili_id) }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col-6">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="uquv_yili_id" class="form-control" required>
                                                                    <option>Tanlash...</option>
                                                                    @foreach($uquv as $uq)
                                                                        @if($uq['id'] == $uqv->uquv_yili_id)
                                                                            <option value="{{$uq['id']}}" selected>{{$uq['nomi']}}</option>
                                                                        @else
                                                                            <option value="{{$uq['id']}}">{{$uq['nomi']}}</option>
                                                                        @endif                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label for="validationCustom01">O'quv yili boshlanish vaqti</label>
                                                                <input type="date" value="{{$uqv->boshlanishi}}" name="boshlanishi" class="form-control"  required>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label for="validationCustom01">O'quv yili tugash vaqti</label>
                                                                <input type="date" value="{{$uqv->tugashi}}" name="tugashi" class="form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label for="validationCustom01">Faol</label>
                                                                <input type="text" value="{{$uqv->faol}}" name="faol" class="form-control"  required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
