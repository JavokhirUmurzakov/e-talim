                            ...
                            <div class="modal-dialog modal-xl modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{ route('mv_admin.ilmiy_unvon.create') }}" enctype="multipart/form-data">
                                            @csrf
                                            @method('post')
                                ...
                                <td>
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <form action="{{ route('mv_admin.ilmiy_unvon.delete',$ilu->id) }}" method="POST">
                                                    @csrf
                                                    @method('delete')
                                                    <input name="id" value="{{$ilu->id}}" class="d-none hidden">
                            ...
                            <div class="modal fade bs-example-modal-xl{{$ilu->id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel{{$ilu->id}}" aria-hidden="true">
                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form name="edit-blog-post-form" id="edit-blog-post-form1" method="post" action="{{ route('mv_admin.ilmiy_unvon.edit',$ilu->id) }}" enctype="multipart/form-data">
                                                @csrf
                                                @method('put')
                                                <div class="container-fluid">
                                                    <div class="row">
