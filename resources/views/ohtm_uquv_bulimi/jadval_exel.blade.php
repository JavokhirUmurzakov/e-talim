                            ...
                            <div class="modal-dialog modal-xl modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title mt-0" id="myExtraLargeModalLabel1">Yangi jadval
                                            qo'shish</h5>
                                    ...
                                    <div class="modal-body">
                                        <form name="add-blog-post-form" id="add-blog-post-form" method="post"
                                              action="{{ route('uquvbulumi.jadval_exel.create') }}"
                                            ...
                                            <div class="container-fluid">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="file">Fayl yuklash (.xlsx)</label>
                                                            <input type="file" name="file" class="form-control"
                                                                   accept=".xlsx,.xlsm,.ppt,.pptx,.doc,.docx,.pdf">
                                                        </div>
                                                    </div>
                    ...
                    <table id="datatable-buttons1"
                        ...
                        @foreach($jadval as $f)
                            <tr>
                                ...
                                <td>
                                    @if($f->file)
                                        <a class="btn btn-outline-{{is_null($f->file)?'warning' : 'success'}} "
                                           data-toggle="tooltip" title="Yuklab olish uchun bosing"
                                           href="{{ asset('storage/uploads/jadval_exel/' . $f->file) }}"><i
                                ...
                                <td>
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <form action="{{ route('uquvbulumi.jadval_exel.delete', $f->id) }}"
                                                      method="POST">
                                                    @csrf
                                                    @method('delete')
                            ...
                            <div class="modal fade bs-example-modal-xl{{$f->id}}"
                                 data-backdrop="static" tabindex="-1"
                                 role="dialog"
                                 aria-labelledby="myExtraLargeModalLabel{{$f->id}}"
                                 aria-hidden="true">
                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title mt-0"
                                                id="myExtraLargeModalLabel{{$f->id}}">Jadvalni
                                                tahrirlash</h5>
                                        ...
                                        <div class="modal-body">
                                            <form name="edit-blog-post-form"
                                                  id="edit-blog-post-form1" method="post"
                                                  action="{{ route('uquvbulumi.jadval_exel.edit',$f->id) }}"
                                                  enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label for="file">Fayl yuklash (.xlsx, .pdf)
                                                                    (ixtiyoriy)</label>
                                                                ...
                                                                <!-- Eski faylni saqlash uchun yashirin maydon -->
                                                                <input type="hidden" name="old_file"
                                                                       value="{{ $f->file }}">

                                                                <small id="fileLabel" class="form-text text-muted">
                                                                    {{ $f->file ? $f->file :  $f->fileNmae }}
                                                                </small>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <script>
                                                            function updateFileName() {
                                                                ...
                                                                if (fileInput.files.length > 0) {
                                                                    ...
                                                                    fileLabel.textContent = "{{ $f->file ? $f->file :  $f->fileName }}";
                                                                }
                                                            }
                                                        </script>
                                                    ...
                                                    <div class="row">
                                                        <button type="submit"
                                                                class="btn btn-primary">Yuborish
                                                        </button>
                                                        <button type="button"
                                                                data-dismiss="modal"
                                                                class="btn btn-secondary">Yopish
