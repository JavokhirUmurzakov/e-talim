    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Kafedra fanlari</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">E-talim</a></li>
                        <li class="breadcrumb-item active">Kafedra fanlari</li>
                    </ol>
                </div>
                            ...
                            <div class="modal-dialog modal-xl modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title mt-0" id="myExtraLargeModalLabel1">Kafedra fanlarini yangi
                                            qator qo'shish</h5>
                                    ...
                                    <div class="modal-body">
                                        <form name="add-blog-post-form" id="add-blog-post-form" method="post"
                                            action="{{ route('uquvbulumi.kafedra_fanlar.create') }}"
                    ...
                    <table id="datatable-buttons1" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        <tbody>
                            @foreach ($fanuq as $f)
                                    ...
                                    <td>
                                        <div class="container-fluid">
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <form action="{{ route('uquvbulumi.kafedra_fanlar.delete', $f->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('delete')
                                ...
                                {{--                            @dd(request()->all()); --}}
                                <div class="modal fade bs-example-modal-xl{{ $f->id }}" data-backdrop="static"
                                    tabindex="-1" role="dialog"
                                    aria-labelledby="myExtraLargeModalLabel{{ $f->id }}" aria-hidden="true">
                                    <div class="modal-dialog modal-xl modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title mt-0"
                                                    id="myExtraLargeModalLabel{{ $f->id }}">Kafedra fanlarini
                                                    tahrirlash</h5>
                                            ...
                                            <div class="modal-body">
                                                <form name="edit-blog-post-form" id="edit-blog-post-form1" method="post"
                                                    action="{{ route('uquvbulumi.kafedra_fanlar.edit', $f->id) }}"
                                                    enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="validationCustom01">Fan nomi</label>
                                                                    <select name="fanlar_id" class="form-control"
                                                                        required>

                                                                        @foreach ($fans as $fa)
                                                                            <option value="{{ $fa->id }}"
                                                                                {{ $f->fanlar_id == $fa->id ? 'selected' : '' }}>
                                                                                {{ $fa->nomi }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="uquv_yili_ohtm_id" class="form-control"
                                                                        ...
                                                                        @foreach ($uquv_yili_ohtms as $uyo)
                                                                            <option value="{{ $uyo->id }}"
                                                                                {{ $uyo->uquv_yili_ohtm_id == $uyo->id ? 'selected' : '' }}>
                                                                                {{ $uyo->nomi }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="guruh_id" class="form-control "
                                                                        ...
                                                                        @foreach ($guruhs as $guruh)
                                                                            <option value="{{ $guruh->id }}"
                                                                                {{ $guruh->guruh_id == $guruh->id ? 'selected' : '' }}>
                                                                                {{ $guruh->nomi }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="soat"
                                                                        class="form-control" placeholder="Dars Soati"
                                                                        value="{{ $f->soat }}" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-1">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <button type="submit"
                                                                class="btn btn-primary">Yuborish</button>
                                                            <button type="button" data-dismiss="modal"
                                                                class="btn btn-secondary">Yopish
                                                            </button>
                                                        </div>
