            ...
            <div class="row">
                @foreach ($fakkafedra as $fakkaf)
                    <div class="col-4" style="width: 18rem; cursor: pointer; transition: 0.3s;"
                        ...
                        onclick="window.location.href='{{route('uquvbulumi.uquv_kafbosh.index', $fakkaf->id) }}'">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="row col-12 mt-lg-4">
                                    <div class="col-lg-4"><strong>Fanlari soni: {{count($fakkaf->fanlar)}}</strong></div>
                                    <div class="col-lg-4"><strong>O'qituvchilari soni: {{count($fakkaf->uqituvchilar)}}</strong></div>
                                    <div class="col-lg-4"><strong>Kursantlari soni: {{count($fakkaf->tinglovchi)}}</strong></div>
                                </div>
                            </div>
                        </div>
                    </div>
