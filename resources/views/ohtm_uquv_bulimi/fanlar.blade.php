                            ...
                            <div class="modal-dialog modal-xl modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{route('uquvbulumi.fanlar.create')}}" enctype="multipart/form-data">
                                            @method('post')
                                            @csrf
                    ...
                    <table id="datatable-buttons1" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        @foreach($fanlar as $fn)
                            <tr>
                                ...
                                <td>{{$fn->fakultet_kafedra->nomi}}</td>
                                <td>
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-6">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <form action="{{route('uquvbulumi.fanlar.delete',$fn->id)}}" method="POST">
                                                    @csrf
                                                    @method('delete')
                            ...
                            <div class="modal fade bs-example-modal-xl{{$fn->id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel{{$fn->id}}" aria-hidden="true">
                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form name="edit-blog-post-form" id="edit-blog-post-form1" method="post" action="{{ route('uquvbulumi.fanlar.edit',$fn->id) }}" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-7">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="fakultet_kafedra_id" class="form-control" required>
                                                                    @foreach($fak_kaf as $f)
                                                                        <option value="{{$f->id}}" {{$fn->fakultet_kafedra_id == $f->id ? 'selected': ''}}>{{$f->nomi}}</option>
                                                                    @endforeach
                                                                </select>
