    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">@foreach ($kaf_nomi as $kaf )
                    {{ $kaf->nomi }}
                    @endforeach</h4>
        ...
        <div class="col-xl-12">
            ...
            <div class="row">
                ...
                <div class="col-4" style="width: 18rem; cursor: pointer; transition: 0.3s;"
                     ...
                     onclick="window.location.href='{{route('uquvbulumi.kaf_guruhlar.index', $kafedra_id)}}'">
                    <div class="card">
                ...
                <div class="col-4" style="width: 18rem; cursor: pointer; transition: 0.3s;"
                     onmouseover="this.style.backgroundColor='#f8f9fa'; this.style.transform='scale(1.05)';"
                     onmouseout="this.style.backgroundColor='transparent'; this.style.transform='scale(1)';"
                     onclick="window.location.href='{{ route('uquvbulumi.kaf_uqituvchi.index', $kafedra_id) }}'">
                    <div class="card">
                        <div class="card-header" style="background-color: #252b3b">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted">O'qituvchilar soni</p>
                        </div>
                    </div>
                </div>
                <!-- Fanlar -->
                <div class="col-4" style="width: 18rem; cursor: pointer; transition: 0.3s;"
                     onmouseover="this.style.backgroundColor='#f8f9fa'; this.style.transform='scale(1.05)';"
                     onmouseout="this.style.backgroundColor='transparent'; this.style.transform='scale(1)';"
                     onclick="window.location.href='{{ route('uquvbulumi.kaf_fanlar.index',  $kafedra_id) }}'">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <h3>{{$fanlar_soni}}</h3>
                            <p class="text-muted">Fanlar soni</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-4" style="width: 18rem; cursor: pointer; transition: 0.3s;"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <h3>5</h3>
                            <p class="text-muted">yuklamalar</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title mb-4 font-size-22 text-center ">Kafedradagi o'qituvchilar haqida malumot</h4>
