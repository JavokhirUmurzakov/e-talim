...
@section('content')
    ...
    <div class="row">
        <div class="card col-lg-12">
            <div class="card-body">
                <h4 class="card-title mb-4 font-size-22 text-center">Kafedra fanlari</h4>
                <div class="table-responsive ">
                    <table class="table table-centered datatable dt-responsive nowrap text-center" data-page-length="5"
                        ...
                        <tr>
                            ...
                            <th><strong>Qisqa nomi</strong></th>
                            <th><strong>Kodi</strong></th>
                            <th><strong>Faolligi</strong></th>
                            <th><strong>Kafedra nomi</strong></th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach ($fanlar as $fan)
                            <tr href="{{route('uquvbulumi.kaf_fanlar.index', $fan->id) }}">
                                <td>{{ $loop->iteration }}</td>
                                <td><strong>{{$fan->fan_nomi}}</strong></td>
                                <td>{{$fan->qs_nomi}}</td>
                                <td>{{$fan->kod}}</td>
                                <td>{{ $fan->faol ? 'Faol' : 'Faol emas' }}</td>
                                <td>{{$fan->kaf_nomi}}</td>
                            </tr>
                        @endforeach
                        </tbody>
