                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form name="add-blog-post-form" id="add-blog-post-form" method="post"
                                                action="{{ route('uquvbulumi.hujjat.create') }}"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="jurnal_nomi" class="form-control" required>
                                                                    <option>Tanlash...</option>
                                                                    @foreach ($jurnal_nomi as $tur)
                                                                        <option value="{{ $tur->id }}">
                                                                            {{ $tur->nomi }} </option>
                                                                    @endforeach
                                                                </select>
                                        ...
                                        <td>
                                            <div class="container-fluid">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <form action="{{ route('uquvbulumi.hujjat.delete', $user->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('delete')
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form name="add-blog-post-form" id="add-blog-post-form"
                                                        method="post"
                                                        action="{{ route('uquvbulumi.hujjat.edit', $user->id) }}"
                                                        enctype="multipart/form-data">
                                                        @csrf
                                                        @method('put')
                                                        <div class="container-fluid">
