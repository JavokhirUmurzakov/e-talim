                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form name="add-blog-post-form" id="add-blog-post-form" method="post"
                                              action="{{ route('uquvbulumi.videmost.create') }}"
                        ...
                        <table id="datatable-buttons1" class="table table-striped table-bordered dt-responsive nowrap text-center "
                            ...
                            @foreach($videmost as $f)
                                <tr>
                                    ...
                                    <td>{{$f->xulosa}}</td>
                                    <td>@if($f->faol) Faol @else Faol emas @endif </td>
                                    <td>
                                        <div class="container-fluid ">
                                            <div class="row">
                                                ...
                                                <div class="col-3">
                                                    <form action="{{ route('uquvbulumi.qayta_topshirish.index', $f->id) }}"
                                                          method="POST">
                                                        @csrf
                                                        @method('get')
                                                        <button type="submit" class="btn btn-primary mr-1"  data-toggle="tooltip" title="Qayta topshirish videmost">
