    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0"> Qayta topshirish Baholar jadvali</h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-outline-success font-size-16 ">Qayta topshirish baholar jurnali</button>
