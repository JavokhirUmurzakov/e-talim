            ...
            <div class="col-md-4">
                <div class="card shadow-lg">
                    <div class="card-body">
                        ...
                        <label>Guruh nomi: {{$fan->guruh_nomi}}</label><br>
                        <div class="row">
                            <p class="col-6"><strong>O'qituvchi FIO:</strong> {{$fan->harbiy_unvon_nomi}} <strong>{{$fan->fio}}</strong></p>
...
{{--                        @dd($fan->jurnal_id);--}}
                        ...
                        <div class="row text-center">
                            <div class="col-4" >
                                <a href="{{route('tinglovchi.baho_joriy.index',$fan->jurnal_id)}}" class="mb-2 font-size-16 font-weight-semibold" data-toggle="tooltip" title="Jurnalga o'tish">Jurnal</a>

{{--                                @dd($fan->jurnal_id)--}}
{{--                                /fan_baho/{{$fan->jurnal_id}}--}}
                            </div>
                            <div class="col-4" >
                                <a href="{{route('tinglovchi.fan_hujjat.index',$fan->jurnal_id)}}" class="mb-2 font-size-16 font-weight-semibold" data-toggle="tooltip" title="Jurnalga o'tish">Hujjatlar</a>
                            </div>
                            <div class="col-4">
                                <a href="{{route('tinglovchi.fan_mavzu.index',$fan->jurnal_id)}}" class="mb-2 font-size-16 font-weight-semibold" data-toggle="tooltip" title="Mavzularga o'tish">Mavzular</a>
                            </div>
                        </div>
