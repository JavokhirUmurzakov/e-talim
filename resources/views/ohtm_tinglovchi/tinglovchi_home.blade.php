...
@section('content')
    ...
    <div class="row mt-1">
        <div class="col-xl-12">
            <h4 class="mb-1">Fanlar</h4>
            <div class="row">
                @foreach($guruh as $gur)
                    <div class="col-4">
                        <div class="card card-hover">
                            <div class="card-header" style="background-color: #282c3c">
                                <span> {{$gur->fakultet_kafedra_nomi}}</span>
                                <i class="mdi mdi-ballot"></i>
                            </div>
                            <div class="card-body text-center">
                                <h3>{{$gur->fan_nomi}}</h3>
                                <p class="text-muted">{{$gur->guruh_nomi}}</p>
                            </div>
    ...
    <div class="row mt-1 card">
        <div class="col-xl-12 card-body">
            <h4 class="mb-1">Guruh ro'yhati</h4>
            <div class="row">
                ...
                <table class="table table-centered datatable dt-responsive nowrap" data-page-length="5"
                    ...
                    <tr>
                        ...
                        <th><strong>Lavozimi</strong></th>
                        <th><strong>Yo'nalishi</strong></th>
                    </tr>
                    </thead>
                    <tbody>

                    @foreach($guruh_l as $uqit)
                        <tr>
                            <td>{{ $loop->iteration }}</td>
                            <td><strong>{{$uqit->tinglovchi_fio}}</strong></td>
                            <td>{{$uqit->harbiy_unvon_nomi}}</td>
                            <td>{{$uqit->tinglovchi_lavozim}}</td>
                            <td>{{$uqit->fak_nomi}}</td>
