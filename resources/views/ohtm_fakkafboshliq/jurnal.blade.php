                            ...
                            <div class="modal-dialog modal-xl modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title mt-0" id="myExtraLargeModalLabel1">Jurnallar jadvaliga yangi
                                            qator qo'shish</h5>
                                        ...
                                        <form name="add-blog-post-form" id="add-blog-post-form" method="post"
                                            ...
                                            <div class="container-fluid">
                                                <div class="row">
                                                    ...
                                                    <div class="col-1">
                                                        <div class="form-group">
                                                            <label for="validationCustom01">Joriy</label>
                                                            <input type="checkbox" name="joriy" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-1">
                                                        <div class="form-group">
