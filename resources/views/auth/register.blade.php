            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="nomi" class="col-md-4 col-form-label text-md-end">{{ __('FIO') }}</label>

                            <div class="col-md-6">
                                <input id="nomi" type="text" class="form-control @error('nomi') is-invalid @enderror" name="nomi" value="{{ old('nomi') }}" required autocomplete="nomi" autofocus>
