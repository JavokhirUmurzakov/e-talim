            ...
            <div class="page-title-box d-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Videmost</li>
                    </ol>
                </div>
                            ...
                            <div class="modal-dialog modal-xl modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h5 class="modal-title mt-0" id="myExtraLargeModalLabel1"> Videmost yangi
                                            qator qo'shish</h5>
                                    ...
                                    <div class="modal-body">
                                        <form name="add-blog-post-form" id="add-blog-post-form" method="post"
                                              action="{{ route('uqituvchi.videmost.create') }}"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="joriy_uqituvchi" class="form-control" required>
                                                                ...
                                                                @foreach($nazoratchi as $nazorat)
                                                                    <option
                                                                        value="{{$nazorat->id}}">{{$nazorat->fio}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="yakuniy_oluvchi" class="form-control" data-toggle="tooltip" title="Yozishda harbiy unvon qisqartmasi va bir kishidan ortiq bo'lsa ' , ' belgisi bilan ajratib yozing namuna bo'lishi mumkin k-n Haydaraliyev D.D."
                                                                   placeholder="Yakuniy nazorat oluvchi" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="uquv_bulim_boshliq" class="form-control" data-toggle="tooltip" title="Ism qisqartmasi va familiya yozing quyidagi namuna D.Haydaraliyev "
                                                                   placeholder="O'quv bo'limi boshlig'i" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="validationCustom01">Xulosa</label>
                                                            <textarea  name="xulosa" class="form-control" rows="2" placeholder="Yakuniy nazorat xulosasini shu yerga yozing" required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                ...
                                <td>
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <form action="{{ route('uqituvchi.videmost_baho.index', $f->id) }}"
                                                      method="POST">
                                                    @csrf
                                                    @method('get')
                                                    <button type="submit" class="btn btn-primary"  data-toggle="tooltip" title="Ko'rish uchun bosing">
                                                        <i class="ri-eye-fill "
                                ...
                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form name="edit-blog-post-form" id="edit-blog-post-form1" method="post" action="{{ route('uqituvchi.videmost.edit', $f->id) }}" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="container-fluid">
                                                    <div class="row">
