    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0"> Oraliq Baholar jadvali</h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-outline-success mb-2 font-size-16 ">Oraliq baholar jurnali</button>
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item font-size-16 text-primary" data-toggle="tooltip" title="Jurnalga o'tish uchun bosing" href="{{route('uqituvchi.baho_yakuniy.index',$jurnal->id)}}">Yakuniyni baholash</a>
                        </div>
                    </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form name="add-blog-post-form" id="add-blog-post-form" method="post"
                                              action="{{ route('uqituvchi.dars_kun.oraliq.create') }}"
                    ...
                    <table id="testTable" class="table table-striped" >
                        ...
                        <tr style="border: none;text-align: center;">
                            ...
                            @foreach ($dars_kuns as $dars )
                                <th title="{{$dars->mavzu->nomi}}" data-toggle="tooltip">{{$dars->sana}}@if ((date("y-m-d") === date('y-m-d', strtotime($dars->sana))))
                                                            ...
                                                            <div class="col-9">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control" name="mavzu_id"
                                                                            id="mavzu">
                                                                        @foreach ($mavzus as $mavzu )
                                                                            <option @if($mavzu['nomi']==$dars->mavzu->nomi) selected @endif value="{{$mavzu['id']}}">{{$mavzu['nomi'] . " | " . $mavzu['soat']}}</option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form name="add-blog-post-form"
                                                                          ...
                                                                          action="{{ route('uqituvchi.baho.oraliq.edit', $bor_id) }}"
                                                                          enctype="multipart/form-data">
                                                                        @method('put')
                                                                        @csrf
                                                                        <div class="container-fluid">
                                                        ...
                                                        <div class="modal-dialog modal-md modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form name="add-blog-post-form"
                                                                          id="add-blog-post-form" method="post"
                                                                          action="{{ route('uqituvchi.baho.oraliq.create') }}"
                                                                          enctype="multipart/form-data">
                                                                        @method('post')
                                                                        @csrf
                                                                        <div class="container-fluid">
