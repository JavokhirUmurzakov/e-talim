                ...
                <div class="card shadow-lg">
                    <div class="card-body">
                        ...
                        <div class="row text-center">
                            <div class="col-4" >
                                <a href="{{route('uqituvchi.baho_jurnal.index' , $fan->jurnal_id)}}" class="mb-2 font-size-16 font-weight-semibold" data-toggle="tooltip" title="Jurnalga o'tish">Jurnal</a>
                            </div>
                            <div class="col-4" >
                                <a href="{{route('uqituvchi.uqituvchi_hujjat.index', $fan->jurnal_id )}}" class="mb-2 font-size-16 font-weight-semibold" data-toggle="tooltip" title="Jurnalga o'tish">Hujjatlar</a>
                            </div>
                            <div class="col-4">
                                <a href="{{route('uqituvchi.mavzular.index' , $fan->jurnal_id)}}" class="mb-2 font-size-16 font-weight-semibold" data-toggle="tooltip" title="Mavzularga o'tish">Mavzular</a>
                            </div>
                        </div>
