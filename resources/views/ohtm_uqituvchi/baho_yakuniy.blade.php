        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-outline-success mb-2 font-size-16 ">Yakuniy baholar jurnali</button>
                        <button type="button" class="btn btn-outline-success mb-2 dropdown-toggle dropdown-toggle-split font-size-16" data-toggle="dropdown" aria-haspopup="true" data-toggle="tooltip" title="Ko'rish uchun bosing" aria-expanded="false">
                            &#9662; <!-- Unicode pastga qaragan uchburchak -->
                        </button>
                        <div class="dropdown-menu">
                            <a class="dropdown-item font-size-16 text-primary" data-toggle="tooltip" title="Jurnalga o'tish uchun bosing" href="{{route('uqituvchi.baho_jurnal.index' ,$jurnal->id)}}">Joriy nazoratni baholash</a>
                            <a class="dropdown-item font-size-16 text-primary" data-toggle="tooltip" title="Jurnalga o'tish uchun bosing" href="{{route('uqituvchi.baho_oraliq.index',$jurnal->id)}}">Oraliqni baholash</a>
                            <a class="dropdown-item font-size-16 text-primary" data-toggle="tooltip" title="Jurnalga o'tish uchun bosing" href="{{route('uqituvchi.baho_mustaqil.index',$jurnal->id)}}">Mustaqil topshiriqni baholash</a>
                            <a class="dropdown-item font-size-16 text-primary" data-toggle="tooltip" title="Jurnalga o'tish uchun bosing" href="{{route('uqituvchi.qayta_topshirish.index',$jurnal->id)}}">Qayta topshirishni baholash</a>
                        </div>
                    </div>
...
{{--                        </button>--}}
                            ...
                            <div class="modal-dialog modal-xl modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title mt-0" id="myExtraLargeModalLabel1">Yangi qator
                                            qo'shish</h5>
                                    ...
                                    <div class="modal-body">
                                        <form name="add-blog-post-form" id="add-blog-post-form" method="post"
                                              action="{{ route('uqituvchi.yakuniy.create') }}"
                    ...
                    <table id="testTable" class="table table-striped text-center mt-2" >
                        <thead class="text-white" style="background: #252b3b">
                        <tr style="border: none;text-align: center;">
                            <th>T/r</th>
                            <th>FIO</th>
                            @foreach ($yakuniys as $dars )
                                ...
                                <div class="modal fade bs-example-modal-xl{{$dars->id}}" data-backdrop="static"
                                    ...
                                    <div class="modal-dialog modal-xl modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form name="add-blog-post-form" id="add-blog-post-form" method="post"
                                                      action="{{ route('uqituvchi.dars_kun.yakuniy.create') }}"
                                                      enctype="multipart/form-data">
                                                    @method('post')
                                                    @csrf
                                                    <div class="container-fluid">
                        ...
                        @foreach($tinglovchis as $ting)
                            <tr style="border: none;">
                                <td>{{++$i}}</td>
                                <td>{{$ting->fio}}</td>
                                @foreach($yakuniys as $d)
                                    <td align="center">
                                        @if((date("y-m-d") === date('y-m-d', strtotime($d->sana))))
                                            @if($d->baholar !=null)
                                                    <?php $bor = false;?>
                                                @foreach($d->baholar as $item)
                                                        <?php
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form name="add-blog-post-form"
                                                                          ...
                                                                          action="{{ route('uqituvchi.baho.yakuniy.edit', $bor_id) }}"
                                                                          enctype="multipart/form-data">
                                                                        @method('put')
                                                                        @csrf
                                                                        <div class="container-fluid">
                                                                            <div class="row">
                                                                                ...
                                                                                <input type="hidden"
                                                                                       name="tinglovchi_id"
                                                                                       value="{{$kursant_id}}">
                                                                                <input type="hidden" name="yakuniy_id"
                                                                                       value="{{$yakuniy_id}}">
                                                ...
                                                @else
                                                    ...
                                                    <div class="modal fade bs-example-modal-xl-create{{$d->id}}-user{{$ting->id}}" data-backdrop="static"
                                                         tabindex="-1" role="dialog"
                                                         aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-md modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form name="add-blog-post-form"
                                                                          id="add-blog-post-form" method="post"
                                                                          action="{{ route('uqituvchi.baho.yakuniy.create') }}"
                                                                          enctype="multipart/form-data">
                                                                        @method('post')
                                                                        @csrf
                                                                        <div class="container-fluid">
