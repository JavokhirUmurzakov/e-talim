                ...
                <div class="card-body">
                            ...
                            <div class="modal-dialog modal-xl modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title mt-0" id="myExtraLargeModalLabel1">Mavzularni yangi
                                            qator qo'shish</h5>
                                    ...
                                    <div class="modal-body">
                                        <form name="add-blog-post-form" id="add-blog-post-form" method="post"
                                              action="{{ route('uqituvchi.mavzu.create') }}"
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="validationCustom01">Mavzular nomi</label>
                                                            <input type="text" name="nomi" class="form-control"
                                                                   placeholder="Mavzu nomi" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="validationCustom01">Dars soati</label>
                                                            <input type="number" name="soat" class="form-control"
                                                                   placeholder="Dars Soati" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="validationCustom01">Fan nomi ,guruh, o'quv yili</label>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="dars_turis_id"
                                                                    class="form-control "
                                                                    required>
                                                                <option>Tanlash...</option>
                                                                @foreach($dars_turis as $adrs_turi)
                                                                    <option
                                                                        value="{{$adrs_turi->id}}">{{$adrs_turi->dars_turi_nomi}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" name="file" class="form-control" accept=".ppt,.pptx,.doc,.docx,.pdf">
                                                        </div>
                                                    </div>
                    ...
                    <table id="datatable-buttons1" class="table table-striped table-bordered dt-responsive nowrap text-center"
                        ...
                        <tr>
                            <th>Mavzular nomi</th>
                            <th>Dars soati</th>
                            <th>Fan nomi ,guruh, o'quv yili</th>
                            <th>Dars turi</th>
                            <th>Fayl</th>
                            <th>Amallar</th>
                        ...
                        @foreach($fanuq as $f)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-outline-{{is_null($f->file_path)?'warning' : 'success'}}"    href="{{is_null($f->file_path)? '#' : '/storage/' . $f->file_path}}" ><i class="fas fa-cloud-download-alt"></i></a>
                                </td>
                                <td>
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <form action="{{ route('uqituvchi.mavzu.delete', $f->id) }}"
                                                      method="POST">
                                                    @csrf
                                                    @method('delete')
...
{{--                            --}}{{--                            @dd(request()->all());--}}
                            <div class="modal fade bs-example-modal-xl{{$f->id}}" data-backdrop="static" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title mt-0" id="myExtraLargeModalLabel{{$f->id}}">Mavzularni
                                                tahrirlash</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            <form name="edit-blog-post-form" id="edit-blog-post-form1" method="post"
                                                  action="{{ route('uqituvchi.mavzu.edit',$f->id) }}"
                                                  enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label for="validationCustom01">Mavzular nomi</label>
                                                                <input type="text" name="nomi" class="form-control"
                                                                       placeholder="Mavzu nomi" value="{{$f->nomi}}" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label for="validationCustom01">Mashg`ulot soati</label>
                                                                <input type="number" name="soat" class="form-control"
