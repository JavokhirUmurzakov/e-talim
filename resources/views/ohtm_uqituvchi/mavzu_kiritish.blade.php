                                        ...
                                        <form name="add-blog-post-form" id="add-blog-post-form" method="post"
                                            ...
                                            <div class="container-fluid">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="validationCustom01">Jurnal</label>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="dars_turis_id"
                                                                    ...
                                                                    @foreach($dars_turis as $adrs_turi)
                                                                        <option
                                                                            {{--                                                                            value="{{$adrs_turi->id}}">{{$adrs_turi->nomi}}--}}
                                                                            value="{{$adrs_turi->id}}" {{$adrs_turi->dars_turis_id==$adrs_turi->id ? 'selected': ''}}>{{$adrs_turi->dars_turi_nomi}}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
