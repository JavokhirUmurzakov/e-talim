    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0"> Mustaqil ta'lim Baholar jadvali</h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-outline-success font-size-16 ">Mustaqil topshiriq jurnali</button>
                        <button type="button" class="btn btn-outline-success dropdown-toggle dropdown-toggle-split font-size-16" data-toggle="dropdown" aria-haspopup="true" data-toggle="tooltip" title="Ko'rish uchun bosing" aria-expanded="false">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form name="add-blog-post-form" id="add-blog-post-form" method="post"
                                              action="{{ route('uqituvchi.dars_kun.mustaqil.create') }}"
                    ...
                    <table id="testTable" class="table table-striped text-center" >
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form name="add-blog-post-form"
                                                                          ...
                                                                          action="{{ route('uqituvchi.baho.mustaqil.edit', $bor_id) }}"
                                                                          enctype="multipart/form-data">
                                                                        @method('put')
                                                                        @csrf
                                                                        <div class="container-fluid">
                                                        ...
                                                        <div class="modal-dialog modal-md modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form name="add-blog-post-form"
                                                                          id="add-blog-post-form" method="post"
                                                                          action="{{ route('uqituvchi.baho.mustaqil.create') }}"
                                                                          enctype="multipart/form-data">
                                                                        @method('post')
                                                                        @csrf
                                                                        <div class="container-fluid">
