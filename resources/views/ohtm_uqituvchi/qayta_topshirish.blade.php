    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0"> Qayta topshirish jadvali</h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-outline-success font-size-16 ">Qayta topshirish jurnali</button>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form name="add-blog-post-form" id="add-blog-post-form" method="post"
                                              action="{{ route('uqituvchi.dars_kun.qayta_topshirish.create') }}"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form name="add-blog-post-form"
                                                                          ...
                                                                          action="{{ route('uqituvchi.baho.qayta_topshirish.edit', $bor_id) }}"
                                                                          enctype="multipart/form-data">
                                                                        @method('put')
                                                                        @csrf
                                                                        <div class="container-fluid">
                                                        ...
                                                        <div class="modal-dialog modal-md modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form name="add-blog-post-form"
                                                                          id="add-blog-post-form" method="post"
                                                                          action="{{ route('uqituvchi.baho.qayta_topshirish.create') }}"
                                                                          enctype="multipart/form-data">
                                                                        @method('post')
                                                                        @csrf
                                                                        <div class="container-fluid">
