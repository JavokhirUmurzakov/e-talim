...
class BahoJurnalController extends Controller
{
    public function index($jurnal_id){
        ...
        $dars_kuns = Dars_kun::with('get_baho_only','mavzu')
        ...
        return view('ohtm_uqituvchi.baho_jurnal', compact('jurnal', 'mavzus', 'dars_kuns', 'tinglovchis', 'bahos', 'baho_array'));
    }
    ...
    public function kursant($jurnal_id){
