...
class DarsKunMustaqilTopshiriqController extends Controller
{
    public function create(Request $request){
        ...
        $cur_dars_kun = Dars_kun::where(['jurnal_id'=>$jurnal_id, 'sana'=>date("d-m-y"), 'mavzu_id'=>$request->mavzu_id, 'nazorat_turi_id'=>4])->first();
