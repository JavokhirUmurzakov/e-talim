...
class QaytaTopshirishController extends Controller
{
    public function index($jurnal_id){
        ...
        $mavzus = Mavzu::where(['jurnal_id'=>$jurnal_id,])->get();

        $tinglovchis = Tinglovchi::where(['guruh_id'=>$jurnal->guruh_id, 'ohtm_id'=>auth()->user()->uqituvchi->ohtm_id ])->get();
        ...
        return view('ohtm_uqituvchi.qayta_topshirish', compact('jurnal', 'mavzus', 'dars_kuns', 'tinglovchis', 'bahos', 'baho_array'));
    }
